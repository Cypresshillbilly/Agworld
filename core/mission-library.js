...
(function(){
  ...
  function inject(){
    ...
    style.textContent = `
      /* Administrator Mission Library — same dark surface system as the live admin workspace */
      .gc-mission-library{margin:0 0 16px;padding:20px;border:1px solid var(--gc-line,rgba(190,214,139,.18));border-radius:13px;background:linear-gradient(145deg,#151c17,#101510);box-shadow:0 4px 18px rgba(0,0,0,.18);color:var(--gc-white,#f3f5ef)}
      .gc-ml-head{display:flex;align-items:flex-start;justify-content:space-between;gap:18px;padding-bottom:13px;border-bottom:1px solid var(--gc-line,rgba(190,214,139,.18))}
      .gc-ml-kicker{font-size:8px;letter-spacing:1.5px;color:var(--gc-green,#a8d51f);font-weight:900}.gc-ml-head h2{margin:5px 0 0;font-size:15px;letter-spacing:1px;color:var(--gc-white,#f3f5ef)}.gc-ml-head p{margin:6px 0 0;color:var(--gc-muted,#9ca79d);font-size:9px}.gc-ml-count{font-size:8px;letter-spacing:1px;color:var(--gc-muted,#9ca79d);font-weight:900;white-space:nowrap;padding-top:3px}
      .gc-ml-toolbar{display:flex;justify-content:flex-end;gap:6px;padding:10px 0 2px}.gc-ml-toolbar button{border:1px solid rgba(168,213,31,.22);background:rgba(255,255,255,.025);color:#bac4b9;border-radius:5px;padding:6px 8px;font-size:7px;font-weight:900;letter-spacing:.7px;cursor:pointer}.gc-ml-toolbar button:hover{background:rgba(168,213,31,.09);border-color:rgba(168,213,31,.38);color:#eff5e8}
      .gc-ml-tree{padding-top:8px}.gc-tree-folder{margin:2px 0}.gc-tree-row{display:flex;align-items:center;min-height:34px;border-radius:6px;cursor:pointer;color:#d8dfd6}.gc-tree-row:hover{background:rgba(168,213,31,.06)}.gc-tree-row.is-selected{background:rgba(168,213,31,.12)}.gc-tree-toggle{width:22px;height:22px;display:grid;place-items:center;border:0;background:transparent;color:#9ca79d;font-size:11px;cursor:pointer;flex:0 0 22px}.gc-tree-icon{width:20px;text-align:center;font-size:13px;flex:0 0 20px}.gc-tree-name{font-size:9px;font-weight:800;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.gc-tree-path{margin-left:auto;padding-right:9px;color:#758078;font-size:7px;letter-spacing:.4px;white-space:nowrap}.gc-tree-children{margin-left:22px;border-left:1px solid rgba(190,214,139,.13);padding-left:5px}.gc-tree-mission{display:flex;align-items:center;gap:5px;min-height:32px;padding:0 4px 0 1px;border-radius:6px}.gc-tree-mission:hover{background:rgba(168,213,31,.06)}.gc-mission-open{display:flex;align-items:center;gap:7px;min-width:0;flex:1;border:0;background:transparent;text-align:left;cursor:pointer;padding:7px 2px;color:#edf2e9}.gc-file-icon{font-size:11px;color:var(--gc-green,#a8d51f)}.gc-file-name{font-size:9px;font-weight:800;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.gc-file-meta{margin-left:auto;font-size:7px;color:#87918a;max-width:24%;text-align:right;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.gc-delete-mission{border:1px solid rgba(184,75,75,.4);background:rgba(184,75,75,.07);color:#e29a9a;border-radius:5px;padding:5px 7px;font-size:7px;font-weight:900;letter-spacing:.6px;cursor:pointer}.gc-delete-mission:hover{background:rgba(184,75,75,.16)}.gc-empty{padding:17px 8px;color:#87918a;font-size:9px}
