...
(()=>{
  ...
  const css=`
#${GUIDE_ID}{position:fixed;right:22px;bottom:22px;z-index:2147482000;display:none;align-items:flex-end;gap:12px;pointer-events:none;font-family:Arial,Helvetica,sans-serif}
...
body.ag-game-mode #${GUIDE_ID}{right:22px;bottom:92px}
body.ag-game-mode .ag-guide-reopen{right:22px;bottom:92px}
