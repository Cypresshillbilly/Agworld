...
async function loadSpatialLayersInBackground() {
  console.info('AG World GIS loader v3 started');
  const spatialSources = window.AGWORLD_SPATIAL_SOURCES || {
  ...
  $('mapStatus').textContent = 'GIS loader v3 started · Municipalities: connecting… · Towns: connecting…';
