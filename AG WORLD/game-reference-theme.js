...
(()=>{
 ...
 const link=document.createElement('link');link.rel='stylesheet';link.href='game-reference-theme.css?v=africa-board-20260912';link.id='agworld-reference-theme';window.AGWorldReferenceThemeReady=new Promise((resolve,reject)=>{
