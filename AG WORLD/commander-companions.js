...
(()=>{
 ...
 function show(id='system-administrator',{speak=true,compact=true,walk=true}={}){ensure();if(!names[id])return;sequence++;stopListening();endTour();guide.stopBriefing();const changed=id!==active||!avatar;active=id;visible=true;wander=0;history=[];modelContext='';q('.ag-companion-send').disabled=false;
