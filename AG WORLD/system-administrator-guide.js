...
(()=>{
 ...
 function briefing(key){
   ...
   const library={
     ...
     game:{title:'Take command of your territory.',copy:'Select a location on the map to bring its information into the Command Center. Expand Territory Stats for the selected area. Use Enter AgWorld in the map menu to explore the full map, and Player View to return to your dashboard.'}
   };
