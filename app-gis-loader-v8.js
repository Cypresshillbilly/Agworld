...
async function loadSpatialLayersInBackground() {
  console.info('AG World GIS loader v8 started');
  ...
  const spatialSources = {
    ...
    country: "https://csggis.drdlr.gov.za/server/rest/services/CSGSearch/MapServer/19/query?where=ISO3_CODE%3D%27ZAF%27&outFields=OBJECTID%2CISO3_CODE%2CSHRT_ENGL%2CLONG_ENGL&returnGeometry=true&outSR=4326&geometryPrecision=5&f=geojson",
    provinces: 'https://law.drdlr.gov.za/server/rest/services/LAW_Spatial_Admin_Boundaries/MapServer/109/query?where=1%3D1&outFields=OBJECTID%2CCODE%2CPROVINCE&returnGeometry=true&outSR=4326&geometryPrecision=5&f=geojson',
