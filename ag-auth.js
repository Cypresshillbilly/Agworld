/* AG WORLD login-only authentication gate — V1.3 */
(() => {
  ...
  const LOGIN_IMAGE = '/Agworld/assets/ag_world_login_v2.jpg?v=20260903-0631';
  ...
  function install() {
    ...
    style.textContent = `
      ...
      @media(max-width:600px){#ag-login-gate .ag-login-panel{width:min(420px,calc(100vw - 24px));padding:20px 25px 18px}.ag-input-wrap{margin-bottom:10px!important}.ag-input-wrap input{height:45px!important}.ag-remember{margin-bottom:12px!important}.ag-login-button{height:46px!important}}
      @media(max-height:650px) and (orientation:landscape){#ag-login-gate .ag-login-panel{width:min(430px,calc(100vw - 30px));padding:14px 24px 12px}.ag-input-wrap{margin-bottom:7px!important}.ag-input-wrap>span{margin-bottom:3px!important}.ag-input-wrap input{height:34px!important}.ag-eye{height:27px!important}.ag-remember{margin-bottom:8px!important}.ag-login-button{height:36px!important}.ag-login-error{min-height:8px!important;margin-top:3px!important}}
    `;
