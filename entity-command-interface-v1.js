...
function style(){
 ...
 #entityInformationSection #farmName{grid-column:1;grid-row:1;margin:0!important;padding:18px 20px 3px!important;font-size:24px!important;line-height:1.15!important;color:#17343d!important;letter-spacing:.2px}
 #entityInformationSection #farmMeta{grid-column:1;grid-row:1;margin:42px 20px 12px!important;align-self:end;font-size:12px!important;color:#6d8189!important}
 #entityInformationSection .stats{grid-column:1;grid-row:2!important;display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;grid-auto-rows:minmax(64px,auto)!important;gap:8px!important;padding:0 14px 10px!important;align-content:start}
 #entityInformationSection .stat{margin:0!important;padding:12px 11px!important;background:linear-gradient(145deg,#ffffff,#e9f0f1)!important;border:1px solid #c7d4d8!important;border-radius:9px!important;box-shadow:0 4px 9px rgba(40,70,80,.08),inset 0 1px 0 #fff!important}
 #entityInformationSection .stat b{display:block!important;font-size:22px!important;color:#1a5d69!important;line-height:1.1}
 #entityInformationSection .stat span{display:block!important;margin-top:5px;font-size:10px!important;font-weight:900;letter-spacing:.8px;color:#71858c}
 #entityInformationSection .farm-extra{grid-column:1;grid-row:3!important;display:grid!important;grid-template-columns:1fr!important;gap:0!important;padding:10px 16px!important;border-top:1px solid #cbd8db!important;background:#dce7e9!important}
 #entityInformationSection .farm-extra>div{display:flex!important;justify-content:space-between!important;align-items:center!important;padding:6px 0!important;border-bottom:1px solid rgba(90,115,123,.12)}
 #entityInformationSection .farm-extra>div:last-child{border-bottom:0}
 #entityInformationSection .farm-extra span{font-size:10px!important;font-weight:900;letter-spacing:.8px;color:#657981}
 #entityInformationSection .farm-extra b{font-size:12px!important;color:#26434c}
 ...
 #entityInformationSection #agworldV2FarmDetailHost .agworld-v2-entity-type{font-size:11px!important;letter-spacing:1.4px!important;color:#16738a!important}
 #entityInformationSection #agworldV2FarmDetailHost h2{font-size:21px!important;letter-spacing:.2px!important;color:#173d48!important}
 #entityInformationSection #agworldV2FarmDetailHost .agworld-v2-status{display:inline-block!important;margin-top:5px!important;padding:5px 9px!important;border-radius:999px!important;background:#dff1e4!important;color:#24713b!important;font-weight:900!important;letter-spacing:.7px}
 ...
 #entityInformationSection #agworldV2FarmDetailHost .agworld-v2-detail-tabs button{min-width:0!important;margin:0!important;padding:9px 6px!important;border-radius:6px!important;background:rgba(255,255,255,.7)!important;color:#61747b!important;border:1px solid transparent!important;font-size:11px!important;font-weight:900!important;letter-spacing:.25px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
 ...
 #entityInformationSection #agworldV2FarmDetailHost .agworld-v2-detail-content{flex:1 1 auto!important;min-height:0!important;overflow:auto!important;padding:16px!important;border-radius:10px!important;border:1px solid #cbd8db!important;background:linear-gradient(145deg,#fff,#f3f7f8)!important;box-shadow:inset 0 1px 0 #fff!important;font-size:14px!important;line-height:1.5!important}
 #entityInformationSection #farmActions{grid-column:2!important;grid-row:3!important;display:flex!important;align-items:center!important;justify-content:flex-end!important;gap:9px!important;padding:11px 16px!important;margin:0!important;border-top:1px solid #c6d4d7!important;background:linear-gradient(180deg,#e7eef0,#d9e3e6)!important}
 #entityInformationSection #farmActions button{width:auto!important;margin:0!important;padding:13px 18px!important;border-radius:7px!important;font-size:17px!important;font-weight:900!important;letter-spacing:.3px!important;line-height:1.2!important;background:#f7fafb!important;color:#31505a!important;border:1px solid #b8c8cc!important;box-shadow:0 2px 5px rgba(20,40,48,.09)!important} #entityInformationSection #farmActions button span,#entityInformationSection #farmActions button .label,#entityInformationSection #farmActions button .button-label{font-size:17px!important;font-weight:900!important;line-height:1.2!important} #entityInformationSection #farm3d,#entityInformationSection #fleetTransactionAction,#entityInformationSection #fleetHistoryAction,#entityInformationSection #farmHistoryBtn{font-size:17px!important;font-weight:900!important;line-height:1.2!important}
