/* AG WORLD — Profile menu: user first, logo moved to map. */
(() => {
  ...
  const css=`
    ...
    /* The menu now starts with the user profile — no logo in the sidebar. */
    body.ag-profile-mode .sidebar .brand{display:none!important}
    body.ag-profile-mode .sidebar .menu-user{display:flex!important;align-items:center!important;text-align:left!important;gap:13px!important;margin:0 1px 16px!important;padding:13px 8px 15px!important;border-top:1px solid rgba(214,196,134,.25)!important;border-bottom:1px solid rgba(214,196,134,.25)!important;box-sizing:border-box!important}
    ...
    /* Center the full AG World logo above the live map, 50% larger than the old menu logo. */
    ...
    @media(max-width:900px){body.ag-profile-mode .sidebar{width:24%!important}body.ag-profile-mode .missions{left:24%!important;width:26%!important}body.ag-profile-mode .map-area{left:50%!important}body.ag-profile-mode .map-area .ag-world-map-logo{width:320px!important;max-width:55%!important}}
  `;
