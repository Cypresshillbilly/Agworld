...
async function init(){
 try{render(await load());}
  ...
  if(f)f.innerHTML='<section class="pf-section footer-connection-error"><div class="pf-title">PROFILE DATA</div><div class="ag-progress-note">Database connection unavailable — the live profile could not be loaded.</div></section>';
 }
}
